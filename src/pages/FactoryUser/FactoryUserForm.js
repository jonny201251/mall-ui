    ...
    render() {
        return (
            <Form core={this.core} layout={{label: 8, control: 16}} direction="vertical-top">
                ...
                <FormItem label="分厂名称" name="name" required={true} >
                    <Select options={this.state.selectData}/>
                </FormItem>
                <FormItem name="users">
                    <SelectInlineRepeater locale='zh' selectMode="multiple" multiple>
                        <FormItem label='登录名' name="loginName" defaultMinWidth={false}><Input style={{width: 120}}/></FormItem>
                        <FormItem label='登录密码' name="loginPassword" defaultMinWidth={false}><Input style={{width: 120}}/></FormItem>
